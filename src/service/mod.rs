...
use crate::types::{
    fork_core_topics, subnet_from_topic_hash, EnrForkId, ForkContext, GossipEncoding, GossipKind,
    GossipTopic, SnappyTransform, Subnet, SubnetDiscovery, ALTAIR_CORE_TOPICS, BASE_CORE_TOPICS,
        ...
        let identify = {
            ...
            let identify_config = if config.private {
                ...
                identify::Config::new("eth2/1.0.0".into(), local_public_key)
                    .with_agent_version(grandine_version::version_with_platform())
                    .with_cache_size(0)
            };
