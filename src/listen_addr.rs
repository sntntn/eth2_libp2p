...
impl ListenAddress {
    ...
    pub fn tcp_port(&self) -> u16 {
        match self {
            ListenAddress::V4(v4_addr) | ListenAddress::DualStack(v4_addr, _) => v4_addr.tcp_port,
            ListenAddress::V6(v6_addr) => v6_addr.tcp_port,
        }
    }

    pub fn udp_port(&self) -> u16 {
        match self {
            ListenAddress::V4(v4_addr) | ListenAddress::DualStack(v4_addr, _) => v4_addr.disc_port,
    ...
    pub fn quic_port(&self) -> u16 {
        match self {
            ListenAddress::V4(v4_addr) | ListenAddress::DualStack(v4_addr, _) => v4_addr.quic_port,
            ListenAddress::V6(v6_addr) => v6_addr.quic_port,
        }
    }
