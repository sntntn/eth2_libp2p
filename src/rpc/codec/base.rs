...
pub struct BaseInboundCodec<TCodec, P>
where
    TCodec: Encoder<RPCCodedResponse<P>> + Decoder,
    P: Preset,
{
...
impl<TCodec, P> BaseInboundCodec<TCodec, P>
where
    TCodec: Encoder<RPCCodedResponse<P>> + Decoder,
    P: Preset,
{
...
pub struct BaseOutboundCodec<TOutboundCodec, P>
where
    TOutboundCodec: OutboundCodec<OutboundRequest<P>>,
    P: Preset,
{
    /// Inner codec for handling various encodings.
...
impl<TOutboundCodec, P> BaseOutboundCodec<TOutboundCodec, P>
where
    P: Preset,
    TOutboundCodec: OutboundCodec<OutboundRequest<P>>,
{
...
impl<TCodec, P> Encoder<RPCCodedResponse<P>> for BaseInboundCodec<TCodec, P>
where
    P: Preset,
    TCodec: Decoder + Encoder<RPCCodedResponse<P>>,
{
    type Error = <TCodec as Encoder<RPCCodedResponse<P>>>::Error;
...
impl<TCodec, P> Decoder for BaseInboundCodec<TCodec, P>
where
    P: Preset,
    TCodec: Encoder<RPCCodedResponse<P>> + Decoder<Item = InboundRequest<P>>,
{
...
impl<TCodec, P> Encoder<OutboundRequest<P>> for BaseOutboundCodec<TCodec, P>
where
    P: Preset,
    TCodec: OutboundCodec<OutboundRequest<P>> + Encoder<OutboundRequest<P>>,
{
    type Error = <TCodec as Encoder<OutboundRequest<P>>>::Error;
...
impl<TCodec, P> Decoder for BaseOutboundCodec<TCodec, P>
where
    P: Preset,
    TCodec: OutboundCodec<OutboundRequest<P>, CodecErrorType = ErrorType>
        + Decoder<Item = RPCResponse<P>>,
{
...
mod tests {
    ...
    use std::sync::Arc;
    use types::{config::Config, nonstandard::Phase, preset::Mainnet};
    ...
    fn test_length_limits() {
        ...
        let max_rpc_size = max_rpc_size(&fork_context, Config::mainnet().max_chunk_size);
